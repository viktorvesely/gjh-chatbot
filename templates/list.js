module.exports = class List {
  ...
  _validateLastElement() {
    ...
    if (current.button && current.button.get().length > 1) throw Error("ListTemplate max_button_exceeded. List's elements can have maximum of one button.");
  }
  ...
  _payload() {
    ...
    this.elements.forEach(e => {
      ...
      e.button ? element.buttons = e.button.get() : false;
